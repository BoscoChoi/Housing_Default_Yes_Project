...
LDN_BORO = gpd.read_file(
    f'https://raw.githubusercontent.com/BoscoChoi/fsds/main/QM_Project/Raw_data/LONDON_BOROUGH.gpkg'
).to_crs(epsg=27700)

LSOA = gpd.read_file(
    f'https://raw.githubusercontent.com/BoscoChoi/fsds/main/QM_Project/Raw_data/LSOA_DEC_2021_BOUNDARIES.gpkg'
).to_crs(epsg=27700)
...
PTAL = pd.read_csv(
    f'https://raw.githubusercontent.com/BoscoChoi/fsds/main/QM_Project/Raw_data/LSOA_aggregated_PTAL_stats_2023.csv'
)
...
stations = gpd.read_file(
    f'https://raw.githubusercontent.com/BoscoChoi/fsds/main/QM_Project/Raw_data/Ldn_train_stations.gpkg'
).to_crs(epsg=27700)
```
...
df_stock = pd.read_csv(f'https://raw.githubusercontent.com/BoscoChoi/fsds/main/QM_Project/Raw_data/CTSOP1_1_2024_03_31.csv')
...
LSOA.plot(
    color=LSOA["cluster_name"].map(cluster_colors),  # map cluster to manual color
    linewidth=0.2,
    edgecolor=None,
    legend=False,
    ax=ax
...
#    title="Cluster Name",
    loc='lower left',
    bbox_to_anchor=(0, -0.07),  # move it slightly down
    fontsize=8,
    title_fontsize=10,
    frameon=True,
    framealpha=0.9
